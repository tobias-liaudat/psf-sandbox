...
starcats_path = '/Users/tliaudat/Documents/PhD/codes/venv_p3/all-W3-tests/validation/test-RCA_hybrid_NOPSFEx/shapepipe_run_2020-01-07_12-05-43/rca_runner/output/'
#stub = 'validation_psf'
stub = 'validation_psf'
save_fullcat = True
...
for name in starcat_names:
    ...
    try:
        ...
        ccd_nb += [38] # Super hardcoded (to work with a incomplete catalog missing RA column)
